<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="Avatar" align="center" width="80">
        <template slot-scope="scope">
           <el-avatar shape="square" size="small" :src="scope.row.avatar"></el-avatar>
        </template>
      </el-table-column>
      <el-table-column label="Nickname" align="center" width="150">
      ...
      <el-table-column label="Date" align="center" width="230">
